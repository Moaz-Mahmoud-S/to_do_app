...
class delete_task_screen extends StatelessWidget
{

  @override
  Widget build(BuildContext context) {
    AppCubit.donetasks=AppCubit.donetasks.toSet().toList();
    return BlocConsumer <AppCubit ,AppStates>(
        listener: (BuildContext context , AppStates states){},
        builder: (BuildContext context , AppStates states){
          return  Conditional.single(
              context: context,
              conditionBuilder: (BuildContext context)  => AppCubit.donetasks.length > 0 ,
              ...
              widgetBuilder: (BuildContext context) {  return ListView.separated(
                  ...
                  {
                    return buildtaskitem(AppCubit.donetasks[index],context);
                  },
